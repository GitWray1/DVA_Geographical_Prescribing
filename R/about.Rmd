...
The **Prescribing map tab** allows users to select their medicine, variable, health area and date range of interest. As the user modifies these inputs the map will dynamically update to show the the presribing for the selected medicine and variable aggregated across the date range. 
...
A user may click on an individual area of the map to highlight this specific area on the line and bar charts, allowing comparison to the national trends. 
